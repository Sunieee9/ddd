...
class Cadastro:
    def __init__(self, id_person, name, email, password, telephone, registartiom_date):
        ...
        self.registratiom_date = registartiom_date  # Data de registro da pessoa
...
def add_cadastro(name, email, password, telephone, registartiom_date):
    ...
    novo_cadastro = Cadastro(id_person, name, email, password, telephone, registartiom_date)  # Cria um novo objeto Cadastro
